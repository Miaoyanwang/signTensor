...
save(error,error_con,error_m,file=paste("Figure6-dimension",rho,".RData",sep=""))
...
save(error,error_con,error_m,file="Model6.RData")
#######################
...
pdf("Model6.pdf",width=4.5,height=3)
