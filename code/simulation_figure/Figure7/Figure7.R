...
save(error,error_con,error_m,file=paste("Figure7-dimension",rho,".RData",sep=""))
...
save(error,error_con,error_m,file="Model7.RData")
#######################
#######################
...
pdf("Model7.pdf",width=4.5,height=3)
