...
save(error,error_con,error_m,file=paste("Figure8-dimension",rho,".RData",sep=""))
...
save(error,error_con,error_m,file="Model8.RData")
#######################
#######################
...
pdf("Model8.pdf",width=4.5,height=3)
